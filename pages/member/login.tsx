  ...
  return (
    <MemberLayout>
      ...
      <LoginFormWrapper>
        ...
        <Button onClick={onClickLogin} width={"100%"} height={"3rem"} bgcolor={"#77b8c0"} color={"white"}>로그인</Button>
        <Button onClick={onClickJoin} width={"100%"} height={"3rem"} bgcolor={"#eeeeee"} color={"black"}>회원가입</Button>
      </LoginFormWrapper>
    </MemberLayout>
  );
};
