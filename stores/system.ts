...
interface SystemTypes{
  dialogIsOpen: boolean; // false일 경우 dialog를 없애고, true일 경우 dialog를 띄움
}
...
const systemSlice = createSlice({
  ...
  initialState,
  reducers:{
    setDialog: (state: SystemTypes, action: PayloadAction<boolean>) => {
...
*/
export const {setDialog} = systemSlice.actions;
